...
public class HttpStatusTest {
    ...
    @Test
    public void testStatus401_UNATHORIZED(){
        HttpStatus.Code code = HttpStatus.Code.UNATHORIZED;

        Assert.assertEquals(401, code.getCode());
        Assert.assertEquals("Unathorized", code.getMessage());
    }
    @Test
    ...
    public void testStatus415(){
        HttpStatus.Code code = HttpStatus.Code.UNSUPPORTED_MEDYA_TYPE;

        Assert.assertEquals(415, code.getCode());
        Assert.assertEquals("Unsupported Medya Type", code.getMessage());
    }
    @Test
    ...
    @Test
    public void testStatus503_SERVICE_UNAVAIABLE(){
        HttpStatus.Code code = HttpStatus.Code.SERVICE_UNAVAIABLE;

        Assert.assertEquals(503, code.getCode());
        Assert.assertEquals("Service Unavaiable", code.getMessage());
    }
    @Test
